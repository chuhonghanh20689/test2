						...
						{{csrf_field()}}
							<div class="panel-body">
								<div class="form-group">
	    							...
	    							<input type="text" name="cat_name" class="form-control" placeholder="Tên danh mục..." value="{{$cat->cat_name}}">
								</div>
								<input type="submit" name="submit" class="btn btn-info pull-right" value="Sửa">
							</div>

					...
					{{csrf_field()}}
						...
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Fullname" name="name" type="text" autofocus="" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="form-control" placeholder="Re-enter Password" name="re_password" type="password" value="" required>
							</div>
							<div class="form-group" >
